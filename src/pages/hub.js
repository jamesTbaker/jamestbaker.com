...
const Section = styled.div`
	...
	${props => props.screenType !== 'small' && `
		padding-top: 5rem;
		padding-bottom: ${props.mediumScreenBottomSpace}rem;
	`}

	${props => props.screenType !== 'small' && props.backgroundColor && `
		background-color: ${StylePatterns.Color(props.backgroundColor)};
		color: ${StylePatterns.Color('grey-17')};
		a,
		a:visited {
			color: ${StylePatterns.Color('red-4')};
			border-bottom: .1rem dotted ${StylePatterns.Color('red-4')};

			&:hover,
			&:active {
				color: ${StylePatterns.Color('red-5')};
				border-bottom: .1rem dotted ${StylePatterns.Color('red-5')};
			}
		}
	`}
`;
		...
		>
			...
			>
				...
				<ProductViewsSubsection
					...
					gridArea="disclaimer"
				>
					<p style={{ padding: '2rem', margin: '2rem 0 0', textAlign: 'center', backgroundColor: StylePatterns.Color('yellow-3'), color: StylePatterns.Color('blue-4') }}>More photos and demo videos are on the way.</p>
				</ProductViewsSubsection>
			</ProductViewsSubsectionsContainer>
		</Section>
		<Section
